			...
			<table>
				<tr>
					...
					<th class="dropdown"><c:choose>
						...
						<div class="dropdown-content">
							<a href="#" onclick="submitWithCh(null)">모두 보기</a> <a
								href="#" onclick="submitWithCh(0)">미확인</a> <a href="#"
								onclick="submitWithCh(1)">반려</a> <a href="#"
								onclick="submitWithCh(2)">확인 완료</a> <a href="#"
								onclick="submitWithCh(3)">발주 완료</a>
						</div></th>
					<th>상세 보기</th>
				</tr>
