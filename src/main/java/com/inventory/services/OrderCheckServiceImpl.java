...
public class OrderCheckServiceImpl implements OrderCheckService {
	...
	@Override
	public List<OrderVo> getOrderDetail() {
		List<OrderVo> list = OrderCheckDao.getOrderDetail();
		return list;
	}
    ...
    public List<OrderVo> getBranchListSummary() {
        return OrderCheckDao.getBranchListSummary();
    }
	...
	// 동현 
	@Override
	public List<OrderVo> getColumnList() {
		List<OrderVo> list = OrderCheckDao.getColumnList();
		return null;
	}

	@Override
	public List<OrderVo> getColumnsList(String column_list) {
	...
	public List<OrderVo> getAllOrders() {
		List<OrderVo> list= OrderCheckDao.getAllOrders();
		return null;
	}
