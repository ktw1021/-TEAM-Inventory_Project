...
public class OrderCheckDaoImpl implements OrderCheckDao {
	...
	public List<OrderVo> getOrderDetail() {
		List<OrderVo> list = sqlSession.selectList("orderCheck.selectOrderDetail");
		return list;
	}
	...
	public List<OrderVo> getColumnList() {
		return sqlSession.selectList("orderCheck.getColumnList");
	}

	@Override
	public List<OrderVo> getAllOrders() {
		return sqlSession.selectList("orderCheck.getAllOrders");
	}
